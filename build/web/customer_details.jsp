    ...
    <body style="background-image: url('images_1/4.jpg');height:100%;background-size: cover;">
        <div>
            <h1 style="font-family:Old English Text MT;"><a href="#"style="color:white;text-decoration:none;" >&nbsp The Times-Journal</a><h1>
                    ...
                    <h2 align="center" style="color:black;"><font><strong>Customer Details</strong></font></h2>
                    <table align="center" cellpadding="5" cellspacing="5" border="1" style="border-radius: 3px;border-style:double;background-color: black;">
                        ...
                        <%
                            try {
                                ...
                                String data;
                                if (query != null) {
                                    data = "Select * from Attributes where (first_name LIKE '%" + query + "%' or last_name LIKE '%" + query + "%' or email LIKE '%" + query + "%' or username LIKE '%" + query + "%' or gender LIKE '%" + query + "%' or age LIKE '%" + query + "%')  and category='Customer'";
                                } else {
                                    data = "SELECT * FROM Attributes WHERE category='Customer'";
                                }

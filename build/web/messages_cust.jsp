    ...
    <body style="background-image: url('images_1/4.jpg');height:100%;background-size: cover;">
        <div>
            <h1 style="font-family:Old English Text MT;"><a href="#"style="color:white;text-decoration:none;" >&nbsp The Times-Journal</a><h1>
                    ...
                    <h2 align="center"style="color:black;"><font><strong>Messages from Customers</strong></font></h2>
                    ...
                    <table align="center" cellpadding="5" cellspacing="5" border="1" style="border-radius: 3px;border-style:double;background-color: black;">
                        ...
                        <%
                            try {
                                ...
                                if (query != null) {
                                    data = "Select * from Contact_Us where (first_name LIKE '%" + query + "%' or email LIKE '%" + query + "%' or phone_number LIKE '%" + query + "%' or subject LIKE '%" + query + "%' or reply_status LIKE '%" + query + "%') and category= 'Customer' ";
                                } else {
                                    data = "SELECT * FROM Contact_Us WHERE category='Customer'";
                                }
                        ...
                        <tr bgcolor="white">
                            ...
                            <td><%=resultSet.getString("reply_status")%></td>
                            <td><a href='reply_message.jsp?email=<%=resultSet.getString("email")%>&id=<%=resultSet.getString("id")%>&name=<%=resultSet.getString("first_name")%>&subject=<%=resultSet.getString("subject")%>&message=<%=resultSet.getString("message")%>' style="color: black; text-decoration: none; ">Reply</a>

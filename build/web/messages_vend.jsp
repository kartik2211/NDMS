...
<%@page import="java.sql.DriverManager"%>
                    ...
                    <h2 align="center"style="color:black;"><font><strong>Messages from Vendors</strong></font></h2>
                    ...
                    <table align="center" cellpadding="5" cellspacing="5" border="1" style="border-radius: 3px;border-style:double;background-color: black;">
                        ...
                        <%
                            try {
                                ...
                                if (query != null) {
                                    data = "Select * from Contact_Us where (first_name LIKE '%" + query + "%' or email LIKE '%" + query + "%' or phone_number LIKE '%" + query + "%' or subject LIKE '%" + query + "%' or reply_status LIKE '%" + query + "%') and category= 'Vendor' ";
                                } else {
                                    data = "SELECT * FROM Contact_Us WHERE category='Vendor'";
                                }
